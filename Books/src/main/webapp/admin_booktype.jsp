...
<%@ page import = "com.mengying.bean.TypeBean,com.mengying.dao.AdminDao,com.mengying.dao.TypeDao,com.mengying.bean.TypeBean,com.mengying.dao.BookDao,com.mengying.bean.AdminBean" %>
