...
<%@ page import = "com.mengying.bean.AdminBean,com.mengying.bean.HistoryBean,com.mengying.dao.AdminDao" %>
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">图书归还记录</div>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>展示所有图书归还记录</li>
