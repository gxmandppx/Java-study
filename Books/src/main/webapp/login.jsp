...
<body class="bootstrap-admin-without-padding" background="static/image/login.jpg" style=" background-repeat:no-repeat ;background-size:100% 100%;
        ...
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" method="post" action="/books/LoginServlet">
                 <% 
					...
					if(state!=null){
					%>
                 <label class="control-label" for="username">账号或密码错误，请重新输入！</label>
                ...
                <br>
                <input type="submit" style="margin-left:17px;" class="btn btn-lg btn-primary"  value="登&nbsp;&nbsp;&nbsp;&nbsp;录"/>
                <a href="/books/register.jsp"><input type="button" style="margin-left:120px;" class="btn btn-lg btn-primary"  value="注&nbsp;&nbsp;&nbsp;&nbsp;册"/></a>
            </form>
        </div>
    </div>
</div>
