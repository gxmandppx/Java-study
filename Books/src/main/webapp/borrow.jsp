...
<%@ page import = "com.mengying.bean.AdminBean,com.mengying.bean.HistoryBean,com.mengying.dao.BookDao,com.mengying.dao.AdminDao" %>
...
<body class="bootstrap-admin-with-small-navbar" background="static/image/user.png" style=" background-repeat:no-repeat ;background-size:100% 100%;
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/books/index2.jsp"><strong>图书馆管理系统</strong></a>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i>    读者,<s:property value="#session.reader.name"/><i class="caret"></i></a>
