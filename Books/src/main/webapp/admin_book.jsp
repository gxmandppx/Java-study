...
<%@ page import = "com.mengying.bean.TypeBean,com.mengying.dao.AdminDao,com.mengying.dao.TypeDao,com.mengying.bean.BookBean,com.mengying.dao.BookDao,com.mengying.bean.AdminBean" %>
...
<body class="bootstrap-admin-with-small-navbar" background="static/image/admin.png" style=" background-repeat:no-repeat ;background-size:100% 100%;
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        <a class="navbar-brand" href="/books/admin.jsp"><strong>图书馆管理系统</strong></a>
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i> 管理员, <s:property value="#session.admin.name"/> <i class="caret"></i></a>
        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                    ...
                    <li>
                        <a href="/books/admin_history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 图书归还记录</a>
                    </li>
                </ul>
